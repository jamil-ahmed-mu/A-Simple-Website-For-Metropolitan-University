...
<body>
      <div class="main fix">
            ...
            <div class="value">
                <h3 class="animated bounceInRight">Please Complete The Form</h3>
                    <form action="action/register.php" method="post" enctype="multipart/form-data">
                         <!--<input title="hidden" value="admin" name="typess" />-->
   					     <input type="text" placeholder="Name" name="name" required/> <br />
                         <input type="text" placeholder="Mobile Number" name="mOBILE"/> <br />
                         <input type="text" placeholder="Email" name="email" required /><br />
                          <input type="text" placeholder="Date of birth(YYYY/MM/DD)" name="birthday" required/><br />
